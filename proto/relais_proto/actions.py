...
def bloc_prompt_contrainte() -> str:
    ...
    return (
        ...
        '["samedi","dimanche"].\n'
        'PORTÉE D\'UNE NÉGATION : elle ne vaut QUE pour ce qu\'elle accompagne, pas '
        'pour toute la phrase. « Plutôt jeudi, et pas le matin » = jours ["jeudi"] ET '
        'exclut_moment "matin" — jeudi est SOUHAITÉ, c\'est le matin qui est refusé. Ne '
        'mets pas "jeudi" dans exclut_jours : ce serait proposer exactement le contraire '
        'de ce que l\'appelant demande.\n'
